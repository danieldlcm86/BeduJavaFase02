package org.bedu.java.backend.sesion8Reto1.controller;

import org.bedu.java.backend.sesion8Reto1.model.Producto;
import org.bedu.java.backend.sesion8Reto1.persistence.ProductoRepository;
...
public class ProductoController {
    ...
    public ResponseEntity<Void> creaProducto(@RequestBody Producto producto){
        ...
        return ResponseEntity.created(URI.create(String.valueOf(producto.getId().toString()))).build();
    }
